...
Dado que $0\leq f \leq 1$ y $\gamma > 0$, entonces el radicando será positivo, por lo que los valores $\lambda_{i}$ son números reales, y de esta manera la solución general de la ecuación en diferencias es de la forma:
...
en donde $c_{i}$ ($i=1,2,3,4$) dependerán de las condiciones iniciales que se utilicen.
