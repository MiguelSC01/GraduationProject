...
Para la investigación, se consideró que cada unidad por mililitro aplicada de EPO aumenta en $0.01\%$ la producción de glóbulos rojos respecto a la producción de una persona sana. De esta manera, la ecuación de $M(n)$ se verá modificada de la siguiente manera: 
